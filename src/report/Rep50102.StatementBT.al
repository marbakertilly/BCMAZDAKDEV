            ...
            dataitem("Integer"; "Integer")
            {
                ...
                dataitem(CurrencyLoop; "Integer")
                {
                    ...
                    dataitem(CustLedgEntryHdr; "Integer")
                    {
                        ...
                        column(Balance1_Lbl; Balance1Lbl)
                        {
                        }
                        column(Date_Lbl; DateLbl)
                        {
                        }
                        column(StatementNo_Lbl; StatementNoLbl)
                        {
                        }
                        column(Startdate_Lbl; StartdateLbl)
                        {
                        }
                        column(Enddate_Lbl; EnddateLbl)
                        {
                        }
                        column(DueDate_Lbl; DueDateLbl)
                        {
                        }
                        column(RemainingAmount_Lbl; RemainingAmountLbl)
                        {
                        }
                        column(Balance_Lbl; BalanceLbl)
                        {
                        }
                        column(Statement_Lbl; StatementLbl)
                        {
                        }

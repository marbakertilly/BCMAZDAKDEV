report 50109 "Aged Accounts ReceivableBT"
{

    DefaultLayout = RDLC;
    RDLCLayout = './src/layout/Rep50109.AgedAccountsReceivableBT.rdl';
    ApplicationArea = Basic, Suite;
    Caption = 'Aldersfordelte tilgodehavender - Partner';
    ...
    dataset
    {
        dataitem(Header; "Integer")
        {
            ...
            {
                DataItemTableView = SORTING("Management Responsible");
                ...
                column(Management_Responsible; Customer."Management Responsible")
                {
                }
    ...
    var
        ...
        AgedAccReceivableCptnLbl: Label 'Aged Accounts Receivable Partner';

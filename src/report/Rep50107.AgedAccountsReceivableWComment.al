report 50107 "AgedAccountsReceivableW.C."
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/layout/Rep50107.AgedAccountsReceivableW.C.rdlc';
    ApplicationArea = Basic, Suite;
    Caption = 'AgedAccountsReceivableW.C.';
    ...
    dataset
    {
        dataitem(Header; "Integer")
        {
            ...
            //>>BT - columns
            column(NewPagePerResponsible; NewPagePerResponsible)
            {
            }
            //<<BT - columns
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(NewPagePerResp; NewPagePerResponsible)
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'New Page per Managment Responsible';
                    }
                }
            }
        }
    ...
    procedure InitializeRequest(NewEndingDate: Date; NewAgingBy: Option; NewPeriodLength: DateFormula; NewPrintAmountInLCY: Boolean; NewPrintDetails: Boolean; NewHeadingType: Option; NewPagePercust: Boolean; NewPagePerResp: Boolean)
    begin
